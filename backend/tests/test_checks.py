...
class TestSimulation:
    ...
    def test_simulation_returns_all_four_agents(self):
        """Simulation results must include all 4 fleet agents."""
        from app.simulate import run_simulation
        results = run_simulation(days=10, seed=42)
        expected = {"risk_review", "incident_rca", "merchant_support", "dispute_response"}
